...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LocationManager locationManager = (LocationManager) this.getSystemService(Context.LOCATION_SERVICE);  // SiSTEMIN KONUM SERVISLERINE ERISMNI SAGLAR
        LocationListener locationListener = new LocationListener() {        // LocationManagerdan konumiun degistiginin bilgisini alabilmek icin kullandigimiz bir arayuzdur.
            @Override
